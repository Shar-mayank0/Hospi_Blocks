...
//                     </header>
//                     <main>
//                         <section className="bg-cover bg-center h-screen" style={{ backgroundImage: "url('https://placehold.co/1920x1080')" }}>
//                             <div className="container mx-auto px-4 h-full flex flex-col justify-center items-center text-center">
//                                 <h1 className="text-5xl font-bold text-white">Store & share medical records securely</h1>
//                                 <p className="text-xl text-white mt-4">Simplifying healthcare data management for patients and providers.</p>
//                                 <button className="bg-blue-600 text-white px-6 py-3 rounded mt-6">Get Started</button>
//                             </div>
//                         </section>
...
//                                         <p className="mt-4 text-gray-700">Automatically sync your health data to a secure blockchain, ensuring privacy and transparency.</p>
//                                     </div>
//                                     <div className="p-6 border rounded-lg">
//                                         <div className="flex justify-center mb-4">
...
//                                         <p className="mt-4 text-gray-700">Choose exactly who can view your health data, giving you complete control over your information sharing.</p>
//                                     </div>
//                                     <div className="p-6 border rounded-lg">
//                                         <div className="flex justify-center mb-4">
...
//                                         <p className="mt-4 text-gray-700">Receive real-time updates on your health metrics, allowing you to make informed decisions promptly.</p>
//                                     </div>
//                                 </div>
//                                 <button className="bg-blue-600 text-white px-6 py-3 rounded mt-8">Explore features</button>
//                             </div>
//                         </section>
//                         <section className="py-16 bg-gray-50">
//                             <div className="container mx-auto px-4 text-center">
//                                 <h2 className="text-4xl font-bold text-blue-600">Register as a Hospital</h2>
//                                 <p className="mt-4 text-gray-700">Get your Hospital registered on</p>
//                                 <button className="bg-blue-600 text-white px-6 py-3 rounded mt-6">Register</button>
//                             </div>
//                         </section>
//                         <section className="py-16 bg-gray-50">
//                             <div className="container mx-auto px-4 text-center">
//                                 <h2 className="text-4xl font-bold text-blue-600">Access Your Health Data</h2>
//                                 <p className="mt-4 text-gray-700">Need health data sync or transparent documents? Contact us for seamless integration and clarity in your health records.</p>
//                                 <button className="bg-blue-600 text-white px-6 py-3 rounded mt-6">User Registration</button>
//                             </div>
//                         </section>
//                     </main>
...
//                                     <a href="#" className="text-gray-600">Company</a>
//                                     <a href="#" className="text-gray-600">Plans & Pricing</a>
//                                 </div>
//                             </div>
//                             <div className="mt-8 flex justify-between items-center">
//                                 <div className="flex items-center">
//                                     <input type="email" placeholder="Input your email" className="border px-4 py-2 rounded-l"/>
...
//                                     <a href="#" className="text-gray-600">Sitemap</a>
//                                 </div>
//                             </div>
//                             <div className="mt-8 flex justify-between items-center">
